# team-communication — Agent A (Engineering Manager)

Agent process for the `team-communication` demo. Connects to the chat server at `http://127.0.0.1:8000` and serves two webhooks on port `9100`:
...
See [`../README.md`](../README.md) for the full model, the sibling agents (B, C), and the seven-step verification checklist.
...
src/
  ...
  agent.py       AssistantIdentity + persona prompt (Engineering Manager)
...
cd yard/examples/rfnry-chat/team-communication/client-python-a
